...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("0. Consultar el país de un atleta dado\n");
	...
	{
		System.out.println("\n" + "Nombre del país al que representa un atleta" + "\n");
		
		String nombreAtleta = (input("Ingrese el nombre del atleta de su interés"));
		
		String nombrePais = calculadora.paisPorAtleta(nombreAtleta);
		
		System.out.println("El atleta " + nombreAtleta + 
				" representa al país de " + nombrePais);
	}
	/**
